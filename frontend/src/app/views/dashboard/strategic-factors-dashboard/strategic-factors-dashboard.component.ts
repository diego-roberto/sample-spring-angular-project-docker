...
@Component({
  selector: 'strategic-factors-dashboard',
  templateUrl: './strategic-factors-dashboard.component.html',
  styleUrls: ['./strategic-factors-dashboard.component.scss']
})
export class StrategicFactorsDashboardComponent implements OnInit {
